...
const createFood = async (req, res, next) => {
  try {
    ...
    // NOTE: Previously donors had to wait for admin verification of their
    // restaurant profile before they could publish a food listing. That gate
    // has been removed — donors can now publish listings directly, the
    // moment they submit the form, with no admin approval step in between.
